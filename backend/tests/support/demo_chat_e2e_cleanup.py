...
from tests.support.demo_knowledge import delete_demo_knowledge_bases_named
...
async def _cleanup() -> None:
    ...
    try:
        ...
        await delete_demo_knowledge_bases_named(
            database,
            _required("COMMON_AGENT_DEMO_E2E_KNOWLEDGE_NAME"),
        )
    finally:
        await database.stop()
...
def main() -> None:
    ...
    print("已清理 Demo 聊天 E2E 会话、员工、知识库和固定 Seed")

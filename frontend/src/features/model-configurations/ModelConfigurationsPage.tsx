      ...
      >
        ...
        >
          ...
          <Form.Item
            ...
            extra="填写平台支持的模型标识，不需要填写 API Key。常用：qwen3.7-max、qwen3.7-plus、qwen3.7-flash、deepseek-v4-pro、deepseek-v4-flash、glm-5.2、kimi-k2.6、qwen-plus、qwen-turbo、qwen-long。"
          >

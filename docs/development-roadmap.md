...
| 后续整改 | `🟨` Wave 7、Wave 8 与 U9-01 已完成；删除 UI、分页搜索和生产化继续按 Wave 9-10 推进，MVP 完成事实不变 |
...
R8-00 至 R8-04、D8-01 至 D8-03、H7-01 至 H7-09 与 U9-01 已完成：RAGFlow 官方源码以 submodule 固定且保持未修改，知识库
...
DELETE API，并由真实 RAGFlow 生命周期验证。下一任务进入 U9-02，在四入口交付删除确认、阻断
说明与真实浏览器闭环。所有后续任务仍遵循

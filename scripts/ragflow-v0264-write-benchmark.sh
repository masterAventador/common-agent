...
EXPECTED_RAGFLOW_COMMIT="${COMMON_AGENT_RAGFLOW_WRITE_EXPECTED_COMMIT:-cb93883f3f8c975eecb2fed81210effeb3bdb06f}"
SOURCE_MODE="${COMMON_AGENT_RAGFLOW_WRITE_SOURCE_MODE:-official}"
EXPECTED_IMAGE_REVISION="${COMMON_AGENT_RAGFLOW_WRITE_IMAGE_REVISION:-}"
DOC_BULK_SIZE="${COMMON_AGENT_RAGFLOW_WRITE_DOC_BULK_SIZE:-4}"
EMBEDDING_CONCURRENCY="${COMMON_AGENT_RAGFLOW_WRITE_EMBEDDING_CONCURRENCY:-1}"

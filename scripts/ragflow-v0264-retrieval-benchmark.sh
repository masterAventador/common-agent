...
EXPECTED_RAGFLOW_COMMIT="${COMMON_AGENT_RAGFLOW_RETRIEVAL_EXPECTED_COMMIT:-cb93883f3f8c975eecb2fed81210effeb3bdb06f}"
SOURCE_MODE="${COMMON_AGENT_RAGFLOW_RETRIEVAL_SOURCE_MODE:-official}"
EXPECTED_IMAGE_REVISION="${COMMON_AGENT_RAGFLOW_RETRIEVAL_IMAGE_REVISION:-}"
